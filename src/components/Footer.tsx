...
export const Footer: React.FC = () => {
  return (
    <footer className="relative -mt-[4rem] flex w-full flex-col items-center rounded-t-[4rem] bg-blue text-sm text-white shadow-[0_-26px_94px] shadow-[rgba(0,0,0,0.15)]">
